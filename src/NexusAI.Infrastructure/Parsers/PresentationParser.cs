...
public sealed class PresentationParser : IDocumentParserWithMetadata
{
    public string[] SupportedExtensions => [".pptx"];
    public string DisplayName => "PowerPoint Presentations";
